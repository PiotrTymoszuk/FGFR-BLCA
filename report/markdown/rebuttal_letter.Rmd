...
Subsequently, we compared the predicted IC50 and AUC resistance metrics between the MIBC consensus classes (__Supplementary Figure XXX___). 
...
We also compared the resistance metrics of FGFR-targeting drugs for cancers with and without mutation of _FGFR3_ (__Supplementary Figure XXX__); in this case, no differences in predicted response between WT and mutant specimens were observed.
